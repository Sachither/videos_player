...
public class VideoOutput implements TextureRegistry.SurfaceProducer.Callback {
    ...
    // Compatibility for Flutter < 3.28
    public void onSurfaceCreated(android.graphics.SurfaceTexture texture) {
        Log.i(TAG, "onSurfaceCreated");
        onSurfaceAvailable();
    }

    public void onSurfaceDestroyed(android.graphics.SurfaceTexture texture) {
